...
public class LaserLine : MonoBehaviour {
    ...
    public Vector3[] positions = { Vector3.zero, new Vector3( 10, 10, 10 ) };
	...
	public void Awake () {
		...
		m_ColorLine.material = Resources.Load("Materials/LaserLineSoft", typeof(Material)) as Material;
		m_WhiteLine.material = Resources.Load("Materials/LaserLineSoft", typeof(Material)) as Material;
        SetPositions( positions);
    }

    void Update () {
		m_ColorLine.SetPosition(0,transform.position);
		m_WhiteLine.SetPosition(0,transform.position);
